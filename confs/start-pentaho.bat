...
set CATALINA_OPTS=-Xms2048m -Xmx4096m  -XX:MaxPermSize=256m -Dfile.encoding=utf-8 -Duser.country=BR -Duser.language=pt -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000 -DDI_HOME=%DI_HOME%
